...
-->
<template>
  <div class="svgComp footerTriangle">
    <div class="paddingTopHolder">
      <div class="absoluteCtnr">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 59.212 15.941" height="60.25" width="223.793">
  <path d="M59.212 0L29.606 15.941 0 0" class="theMainPath" />
</svg>
      </div>
    </div>
  </div>
