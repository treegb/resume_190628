...
-->
<template>
  <div class="svgComp arrowThick">
    <div class="paddingTopHolder">
      <div class="absoluteCtnr">

<svg xmlns="http://www.w3.org/2000/svg" width="160.5" height="239.578" viewBox="0 0 160.5 239.578">
  <path class="pathWithMainColor" d="M140.062 219.903l20.438-19.961-39.995-40.076-39.996-40.077 39.996-40.076L160.5 39.637l-20.438-19.961C128.822 8.697 119.132-.156 118.532.002 116.892.433 0 118.554 0 119.78c0 1.221 116.902 119.363 118.54 119.796.596.158 10.281-8.695 21.522-19.673z"/>
</svg>
      </div>
    </div>
  </div>
